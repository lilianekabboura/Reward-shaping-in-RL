    ...
    def train(self):
        ...
        for i_episode in range(self.hyperparams.num_episodes):
            ...
            if self.training_method == "epsilon_greedy" or self.training_method == "greedy":
                ...
                score, time_step, total_reward_shaped, steps_done = Methods.run_episode_with_GBRS_MC(self.env_name,
...
def init_hyperparams():
    ...
    hyperparams.ENV = 'MountainCar-v0'
    hyperparams.BATCH_SIZE = 64
    hyperparams.TAU = 0.005
    hyperparams.GAMMA = 0.99  # 0.8
    hyperparams.LEARNING_RATE = 0.001  # 0.5 #0.01
